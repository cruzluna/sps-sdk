...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['SYSTEM_PROMPT_STORAGE_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['SYSTEM_PROMPT_STORAGE_LOG'] or 'warn' if it isn't set.
   */
...
export class SystemPromptStorage {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? SystemPromptStorage.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('SYSTEM_PROMPT_STORAGE_LOG'), "process.env['SYSTEM_PROMPT_STORAGE_LOG']", this) ??
      defaultLogLevel;
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://api.cruzluna.dev';
  }
  ...
  static SystemPromptStorage = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static SystemPromptStorageError = Errors.SystemPromptStorageError;
