import fs from 'fs';
import type { ResponseLike } from 'system-prompt-storage/internal/to-file';
import { toFile } from 'system-prompt-storage/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('system-prompt-storage/core/uploads');
    await expect(
